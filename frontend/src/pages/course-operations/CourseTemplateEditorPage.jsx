...
const emptyTemplate = { id: "new", name: "", description: "", usageScope: "course", audience: "class", audienceClassIds: [], status: "draft", classes: 0, updatedAt: "尚未儲存", nodes: [], edges: [] };
