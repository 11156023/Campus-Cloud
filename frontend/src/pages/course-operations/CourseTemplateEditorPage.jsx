...
export default function CourseTemplateEditorPage() {
  ...
  if (loading) return <div className={styles.emptyState}><p>正在讀取多機環境…</p></div>;
